...
The [SetO365AzureElevatedAccess.ps1](Examples/SetO365AzureElevatedAccess.ps1) script demonstrates how to obtain and remove elevated Azure access using either the current user or a specified UPN.
