@{
    ...
    FunctionsToExport    = @('Connect-O365Admin', 'Get-O365ToDo', 'Get-O365AzureSpeechServices', 'Get-O365Bookings', 'Get-O365BriefingEmail', 'Get-O365CalendarSharing', 'Get-O365CommunicationToUsers', 'Get-O365Cortana', 'Get-O365Dynamics365CustomerVoice', 'Get-O365Dynamics365SalesInsights', 'Get-O365Forms', 'Get-O365GraphDataConnect', 'Get-O365Groups', 'Get-O365MicrosoftSearch', 'Get-O365MicrosoftTeams', 'Get-O365ModernAuthentication', 'Get-O365MyAnalytics', 'Get-O365Planner', 'Get-O365TenantID', 'Get-O365Whiteboard', 'Invoke-O365Admin')
